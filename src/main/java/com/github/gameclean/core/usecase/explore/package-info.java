 ...
 * <em>ambient</em>, not a parameter: the use case asks {@code PlayerOperationsOutputPort} who is
 * acting and constructs the {@code PlayerId} value object inside the use case. Looking <em>at</em> a
 * target and moving between scenes are deferred to later user goals under this same summary goal.
 */
