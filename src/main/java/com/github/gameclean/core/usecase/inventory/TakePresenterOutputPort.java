 ...
 * {@code presentTargetNoLongerAvailable}.</b> They are genuinely different domain outcomes that happen to read the
 * same to the player: {@code presentTargetNoLongerAvailable} is the <em>read-side</em> miss (re-provisioning for a
